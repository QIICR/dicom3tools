...
Module="MicroscopyBulkSimpleAnnotations"
	...
	Sequence="AnnotationGroupSequence"									Type="1"	VM="1-n"
		Name="AnnotationGroupNumber"									Type="1"	NotZeroError=""
		...
		Verify="CommonZCoordinateValue"															Condition="CommonZCoordinateValueAndAnnotationCoordinateTypeIsNot3D"	ThenErrorMessage="Only valid for AnnotationCoordinateType of 3D" ShowValueWithMessage="true"
