...
DefineMacro="DeviceMotionControlMacro"
	Sequence="DeviceMotionControlSequence"				Type="3"	VM="1"
		Sequence="DeviceMotionParameterCodeSequence"	Type="1"	VM="1"
			InvokeMacro="CodeSequenceMacro"
		SequenceEnd
		Name="DeviceMotionExecutionMode"				Type="1C"	Condition="DeviceMotionObservationModeAbsent"	StringEnumValues="DeviceMotionExecutionMode"	mbpo="true"
		Name="DeviceMotionObservationMode"				Type="1C"	Condition="DeviceMotionExecutionModeAbsent"		StringEnumValues="DeviceMotionObservationMode"	mbpo="true"
	SequenceEnd
MacroEnd
...
Module="RTImage"
	...
	Name="XRayImageReceptorTranslation"					Type="3"
	...
	Sequence="ExposureSequence"							Type="3"	VM="1-n"
		...
		Sequence="ApplicatorSequence"					Type="3"	VM="1"
			...
			Sequence="ApplicatorGeometrySequence"		Type="3"	VM="1"
				Name="ApplicatorApertureShape"			Type="1"	StringDefinedTerms="ApplicatorApertureShape"
				Name="ApplicatorOpening"				Type="1C"	Condition="ApplicatorApertureShapeIsSquareOrCircular"
				Name="ApplicatorOpeningX"				Type="1C"	Condition="ApplicatorApertureShapeIsRectangle"
				Name="ApplicatorOpeningY"				Type="1C"	Condition="ApplicatorApertureShapeIsRectangle"
			SequenceEnd
			Name="SourceToApplicatorMountingPositionDistance"	Type="3"
...
Module="RTDose"
	...
	Sequence="ReferencedTreatmentRecordSequence"				Type="1C"	VM="1"		Condition="NeedReferencedTreatmentRecordSequence"
		InvokeMacro="SOPInstanceReferenceMacro"
		Sequence="ReferencedBeamSequence"						Type="1C"	VM="1"		NoCondition=""
			Name="ReferencedBeamNumber"							Type="1"
		SequenceEnd
	SequenceEnd
	...
	Sequence="DerivationCodeSequence"							Type="3"	VM="1-n"
		InvokeMacro="CodeSequenceMacro"													DefinedContextID="7220"
	SequenceEnd
	Sequence="ReferencedInstanceSequence"						Type="3"	VM="1-n"
		InvokeMacro="SOPInstanceReferenceMacro"
		Sequence="PurposeOfReferenceCodeSequence"				Type="1"	VM="1"
			InvokeMacro="CodeSequenceMacro"												DefinedContextID="7221"
		SequenceEnd
	SequenceEnd
ModuleEnd
...
Module="ROIContour"
	Sequence="ROIContourSequence"								Type="1"	VM="1-n"
		...
		Sequence="SourcePixelPlanesCharacteristicsSequence"		Type="3"	VM="1"
			Name="PixelSpacing"									Type="1"
			Name="SpacingBetweenSlices"							Type="1"
...
Module="RTFractionScheme"
	Sequence="FractionGroupSequence"							Type="1"	VM="1-n"
		...
		Sequence="ReferencedBeamSequence"						Type="1C"	VM="1-n"	Condition="NumberOfBeamsNotZero"
			...
			Name="BeamDeliveryDurationLimit"					Type="3"
		SequenceEnd
...
Module="RTBeams"
	Sequence="BeamSequence"										Type="1"	VM="1-n"
		...
		Sequence="WedgeSequence"								Type="1C"	VM="1-n"	Condition="NumberOfWedgesNotZero"
			...
			Name="EffectiveWedgeAngle"							Type="3"
		SequenceEnd
		...
		Sequence="CompensatorSequence"							Type="1C"	VM="1-n"	Condition="NumberOfCompensatorsNotZero"
			...
			Name="CompensatorType"								Type="3"	StringDefinedTerms="CompensatorType"
			Name="MaterialID"									Type="2"
		...
		Sequence="ReferencedDoseReferenceSequence"					Type="3"	VM="1-n"
			Name="ReferencedDoseReferenceNumber"					Type="1"
			Name="DepthValueAveragingFlag"							Type="1C"	NoCondition=""	StringEnumValues="YesNoFull"
			Sequence="BeamDoseVerificationControlPointSequence"		Type="3"	VM="2-n"
				...
				Name="BeamDosePointDepth"							Type="1C"	NoCondition=""		# Required for all but the last items in that sequence :(
				Name="BeamDosePointEquivalentDepth"					Type="1C"	NoCondition=""		# Required for all but the last items in that sequence :(
				Name="BeamDosePointSSD"								Type="1C"	NoCondition=""		# Required for all but the last items in that sequence :(
				Name="BeamDosePointSourceToExternalContourDistance"	Type="3"
			SequenceEnd
		SequenceEnd
		...
		Sequence="ControlPointSequence"							Type="1"	VM="2-n"
			...
			Name="ExternalContourEntryPoint"					Type="3"
			Name="SourceToSurfaceDistance"						Type="3"
			Name="SourceToExternalContourDistance"				Type="3"
		SequenceEnd
	SequenceEnd
ModuleEnd
...
Module="RTBrachyApplicationSetups"
	...
	Sequence="ApplicationSetupSequence"							Type="1"	VM="1-n"
		...
		Sequence="ChannelSequence"								Type="1"	VM="1-n"
			...
			Name="SourceApplicatorTipLength"					Type="2C"	Condition="ChannelEffectiveLengthPresent"
			...
			Name="ApplicatorShapeReferencedROINumber"			Type="3"
			...
			Name="ChannelEffectiveLength"						Type="3"
			Name="ChannelInnerLength"							Type="2C"	Condition="ChannelEffectiveLengthPresent"
			Name="AfterloaderChannelID"							Type="3"
...
Module="RTBrachySessionRecord"
	...
	Sequence="TreatmentSessionApplicationSetupSequence"			Type="1"	VM="1-n"
		...
		Sequence="RecordedChannelSequence"						Type="1"	VM="1-n"
			Name="ChannelNumber"								Type="1"
			Name="ReferencedChannelNumber"						Type="3"
			Name="ChannelLength"								Type="2"
			Name="ChannelEffectiveLength"						Type="3"
			Name="ChannelInnerLength"							Type="2C"	Condition="ChannelEffectiveLengthPresent"
			Name="AfterloaderChannelID"							Type="3"
			...
			Sequence="RecordedSourceApplicatorSequence"			Type="3"	VM="1-n"
				...
				Name="SourceApplicatorTipLength"				Type="2C"	Condition="ChannelEffectiveLengthPresentInParent"
				Name="SourceApplicatorManufacturer"				Type="3"
			...
			Sequence="BrachyControlPointDeliveredSequence"		Type="1"	VM="2-n"
				...
				SequenceEnd
			SequenceEnd
			Sequence="PulseSpecificBrachyControlPointDeliveredSequence"	Type="3"	VM="1-n"
				Name="PulseNumber"										Type="1"
				Name="SafePositionExitDate"								Type="1"
				Name="SafePositionExitTime"								Type="1"
				Name="SafePositionReturnDate"							Type="1"
				Name="SafePositionReturnTime"							Type="1"
				Sequence="BrachyPulseControlPointDeliveredSequence"		Type="1"	VM="1-n"
					Name="ReferencedControlPointIndex"					Type="3"
					Name="TreatmentControlPointDate"					Type="1"
					Name="TreatmentControlPointTime"					Type="1"
					Name="ControlPointRelativePosition"					Type="1"
...
Module="RTIonToleranceTables"
	Sequence="IonToleranceTableSequence"						Type="3"	VM="1-n"
		...
		Name="HeadFixationAngleTolerance"						Type="3"
		Name="ChairHeadFramePositionTolerance"					Type="3"
		Name="FixationLightAzimuthalAngleTolerance"				Type="3"
		Name="FixationLightPolarAngleTolerance"					Type="3"
	SequenceEnd
ModuleEnd
...
Module="RTIonBeams"
	Sequence="IonBeamSequence"									Type="1"	VM="1-n"
		...
		Sequence="DepthDoseParametersSequence"					Type="3"	VM="1"
			Name="ReferenceDoseDefinition"						Type="1"			StringDefinedTerms="ReferenceDoseDefinition"
			Name="DistalDepth"									Type="1"
			Name="DistalDepthFraction"							Type="1"
			Name="NominalRangeModulatedRegionDepths"			Type="1C"			Condition="ReferenceDoseDefinitionIsCenter"
			Name="NominalRangeModulationFractions"				Type="1C"			Condition="NominalRangeModulatedRegionDepthsPresent"
		SequenceEnd
		...
		Name="FixationEye"										Type="3"	StringEnumValues="FixationEye"
		Name="FinalCumulativeMetersetWeight"					Type="1C"	NoCondition=""
		Name="NumberOfControlPoints"							Type="1"
		Sequence="IonControlPointSequence"						Type="1"	VM="2-n"
			...
			Name="ScanSpotReorderingAllowed"					Type="3"	StringEnumValues="ScanSpotReorderingAllowed"
			...
			Name="ChairHeadFramePosition"						Type="3"
			Name="TableTopVerticalPosition"						Type="2C"	NoCondition=""
			Name="TableTopLongitudinalPosition"					Type="2C"	NoCondition=""
			Name="TableTopLateralPosition"						Type="2C"	NoCondition=""
...
Module="RTIonBeamsSessionRecord"
	...
	Sequence="TreatmentSessionIonBeamSequence"					Type="1"	VM="1-n"
		...
		Name="SpecifiedTreatmentTime"							Type="3"
		Name="DeliveredTreatmentTime"							Type="3"
		Sequence="DeliveredDepthDoseParametersSequence"			Type="3"	VM="1"
			Name="DeliveredReferenceDoseDefinition"				Type="1"			StringDefinedTerms="ReferenceDoseDefinition"
			Name="DeliveredDistalDepth"							Type="1"
			Name="DeliveredDistalDepthFraction"					Type="1"
			Name="DeliveredNominalRangeModulatedRegionDepths"	Type="1C"			Condition="DeliveredReferenceDoseDefinitionIsCenter"
			Name="DeliveredNominalRangeModulationFractions"		Type="1C"			Condition="DeliveredNominalRangeModulatedRegionDepthsPresent"
		SequenceEnd
		Name="NumberOfControlPoints"							Type="1"
		Sequence="IonControlPointDeliverySequence"				Type="1"	VM="1-n"
			...
			Name="ScanningSpotSize"								Type="3"
			Name="ScanSpotSizesDelivered"						Type="3"
			Name="NumberOfPaintings"							Type="1C"	Condition="ScanModeAboveIsModulatedOrModulatedSpec"
			Name="ScanSpotReordered"							Type="3"	StringEnumValues="YesNoFull"
			Name="ScanSpotPrescribedIndices"					Type="1C"	Condition="ScanSpotReorderedIsYes"
			Name="PatientSupportAngle"							Type="1C"	NoCondition=""
			Name="PatientSupportRotationDirection"				Type="1C"	NoCondition=""	StringEnumValues="RotationDirectionWithNone"
			Name="TableTopPitchAngle"							Type="2C"	NoCondition=""
			Name="TableTopPitchRotationDirection"				Type="2C"	NoCondition=""	StringEnumValues="RotationDirectionWithNone"
