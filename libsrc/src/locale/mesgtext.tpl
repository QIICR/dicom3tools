...
Index="BadFileMetaInformationVersion"		English="Bad FileMetaInformationVersion Attribute - wrong VR, length or not 0x00,0x01"
...
Index="BadPixelRepresentation"				English="Bad PixelRepresentation - not a US with a single value"
...
Index="BadValuePixelRepresentation"		English="PixelRepresentation has bad value - not 0 (unsigned) or 1 (signed)"
Index="BadValueRepresentation"			English="Invalid Value Representation"
Index="BasicOffsetTableEntryDoesNotPointToItemTag"			English="BasicOffsetTable entry does not point to Item Tag"
Index="BasicOffsetTableEntryIsNotEvenLength"				English="BasicOffsetTable entry is not even length"
Index="Bytes"					English="bytes"
Index="CharacterInvalidForThisVR"		English="Character invalid for this VR"
Index="CharacterInvalidForCharacterRepertoire"		English="Character invalid for character repertoire (default or as defined in SpecificCharacterSet)"
Index="CodeMeaningForMeasurementUnitsBeginsOrEndsWithQuotationCharacters"	English="CodeMeaning in MeasurementUnitsCodeSequence begins or ends with quotation characters"
Index="CodeSequenceContainsConceptForUnknown"	English="Code Sequence contains concept for unknown"
Index="CodeValueContainsInvalidCharactersForCodingScheme"	English="CodeValue contains invalid characters for coding scheme"
Index="CodingSchemeDesignatorInUnitsCodeSequenceIsNotUCUM"	English="CodingSchemeDesignator in a units Code Sequence is not UCUM"
...
Index="ConflictingDirectionsInPatientOrientationCannotBePresentInSameValue"		English="Conflicting directions in PatientOrientation cannot be present in same value"
...
Index="DuplicateAnnotationGroupUID"	English="Duplicate AnnotationGroupUID"
...
Index="EmptyTransferSyntaxUIDInMetaInformationHeader"	English="Empty or missing TransferSyntaxUID in Meta Information Header"
...
Index="EncapsulatedPixelDataFragmentDoesNotStartWithSOIMarker"			English="Encapsulated pixel data fragment does not start with SOI marker"
Index="EncapsulatedPixelDataFragmentIsZeroLength"				English="Encapsulated pixel data fragment is zero length"
IIndex="EncapsulatedPixelDataFragmentNotEvenLength"			English="Encapsulated pixel data fragment is not even length"
ndex="EqualTo"				English="equal to"
...
Index="ExampleRootForUID"		English="Inappropriate example root for UID"
...
Index="ExtendedOffsetTableEntryDoesNotPointToItemTag"		English="ExtendedOffsetTable entry does not point to Item Tag"
Index="ExtendedOffsetTableNotPermittedWhenBasicOffsetTablesPresent"			English="ExtendedOffsetTable not permitted when BasicOffsetTable is present"
...
Index="FrameIncrementPointerValueNotPresentInDataset"				English="FrameIncrementPointer value is not present in dataset"
Index="FunctionalGroupSequenceAlreadyUsedInSharedFunctionalGroupsSequence"				English="Functional Group Sequence already used in SharedFunctionalGroupsSequence"
...
Index="IllegalCharacterInPatientOrientation"					English="Illegal character in PatientOrientation"
...
Index="LengthOfBasicOffsetTableNotEqualToNumberOfFrames"	English="Length of BasicOffsetTable is not equal to NumberOfFrames"
Index="LongCodeValueTooShort"			English="LongCodeValue is too short - required to be >16"
Index="LongPrimitivePointIndexListFirstValueNotOne"	English="LongPrimitivePointIndexList first value is not 1"
Index="LongPrimitivePointIndexListValueNotAscending"	English="LongPrimitivePointIndexList value not ascending"
Index="LongPrimitivePointIndexListNumberOfValuesDoesNotMatchNumberOfAnnotations"	English="LongPrimitivePointIndexList number of values does not match NumberOfAnnotations"
Index="LongPrimitivePointIndexListValueNotWithinPointCoordinatesData"				English="LongPrimitivePointIndexList value not within PointCoordinatesData"
Index="LowestValueInVectorIsNotOne"					English="Lowest value in vector is not one"
Index="LUTDataBad"				English="LookupTableData bad"
Index="LUTDataMultiplyDefined"			English="LookupTableData multiply defined"
Index="LUTDataNotNumeric"			English="LookupTableData has non-numeric value representation"
Index="LUTDataWithoutDescriptor"		English="LookupTableData without Descriptor"
Index="LUTDataWrongLength"			English="LookupTableData has wrong length"
Index="LUTDescriptorBad"			English="LookupTableDescriptor is bad"
Index="LUTDescriptorNotNumeric"			English="LookupTableDescriptor has non-numeric value representation"
Index="LUTDescriptorWrongVM"			English="LookupTableDescriptor has wrong value multiplicity"
Index="Macro"					English="Macro"
Index="MediaStorageSOPInstanceUIDDifferentFromSOPInstanceUID"	English="MediaStorageSOPInstanceUID different from SOPInstanceUID"
Index="MediaStorageSOPClassUIDDifferentFromSOPClassUID"	English="MediaStorageSOPClassUID different from SOPClassUID"
Index="MediaStorageSOPInstanceUIDButMissingSOPInstanceUIDAndNotADirectory"	English="MediaStorageSOPInstanceUID but missing SOPInstanceUID and not a directory"
Index="MediaStorageSOPClassUIDNotMediaStorageDirectoryStorageSOPClassUID"	English="MediaStorageSOPClassUID not Media Storage Directory Storage SOP Class UID"
Index="MediaStorageSOPClassUIDButMissingSOPClassUIDAndNotADirectory"	English="MediaStorageSOPClassUID but missing SOPClassUID and not a directory"
...
Index="MissingSOPInstanceThatWasReferenced"	English="Missing SOPInstanceUID that was referenced"
...
Index="NotPermittedWhenBasicOffsetTablesPresent"			English="Not permitted when BasicOffsetTable is present"
Index="NonMonochromeSignedPixelRepresentation"	English="Signed PixelRepresentation for other than monochrome PhotometricInterpretation"
Index="NoNeedForWindowLevelWidth"		English="No need to specify window level or width for this PhotometricInterpretation"
...
Index="PatientOrientationRowAndColumnDirectionsCannotBeIdentical"			English="PatientOrientation row and column directions cannot be identical"
Index="PixelAspectRatioNotPermittedWhenOneToOne"			English="PixelAspectRatio may not be present when it has a ratio of 1:1"
...
Index="PixelRepresentationIncorrect"		English="PixelRepresentation incorrect"
Index="PixelRepresentationUnnecessary"		English="PixelRepresentation unnecessary"
...
Index="PointCoordinatesDataNumberOfTuplesNotMultipleOfFourTimesNumberOfAnnotationsForRECTANGLEOrELLIPSEGraphicType"			English="PointCoordinatesData number of coordinate tuples not multiple of four times NumberOfAnnotations for RECTANGLE or ELLIPSE GraphicType"
Index="PointCoordinatesDataNumberOfValuesDoesNotMatchNumberOfAnnotationsForPOINTGraphicType"			English="PointCoordinatesData number of values does not match NumberOfAnnotations for POINT GraphicType"
Index="PointCoordinatesDataNumberOfValuesNotMultipleOfSizeOfCoordinateTuple"			English="PointCoordinatesData number of values not multiple of size of coordinate tuple"
...
Index="ThreeDCoordinatesContentItemHasIncorrectNumberOfGraphicDataValues"	English="3D coordinates content item has incorrect number of GraphicData values"
Index="ThreeDCoordinatesContentItemPolygonNotClosedDifferentFirstAndLastCoordinateValues"	English="3D coordinates content item of GraphicType POLYGON has different first and last coordinate values but is expected to be closed"
...
Index="TotalPixelMatrixRowsNotAnExactMultipleOfRows"	English="TotalPixelMatrixRows is not an exact multiple of Rows"
...
Index="UCUMCodingSchemeDesignatorIsUsedInSequenceOtherThanUnitsCodeSequence"	English="UCUM CodingSchemeDesignator is used in sequence other than a units Code Sequence"
