...
DirectoryRecord="IMAGE"			Name="PhotoacousticImageStorage"					Desc="Photoacoustic Image Storage"				Uid="1.2.840.10008.5.1.4.1.1.6.3"
...
DirectoryRecord="WAVEFORM"		Name="MultichannelRespiratoryWaveformStorage"			Desc="Multi-channel Respiratory Waveform Storage"			Uid="1.2.840.10008.5.1.4.1.1.9.6.2"
DirectoryRecord="WAVEFORM"		Name="RoutineScalpElectroencephalogramWaveformStorage"	Desc="Routine Scalp Electroencephalogram Waveform Storage"	Uid="1.2.840.10008.5.1.4.1.1.9.7.1"
DirectoryRecord="WAVEFORM"		Name="ElectromyogramWaveformStorage"					Desc="Electromyogram Waveform Storage"						Uid="1.2.840.10008.5.1.4.1.1.9.7.2"
DirectoryRecord="WAVEFORM"		Name="ElectrooculogramWaveformStorage"					Desc="Electrooculogram Waveform Storage"					Uid="1.2.840.10008.5.1.4.1.1.9.7.3"
DirectoryRecord="WAVEFORM"		Name="SleepElectroencephalogramWaveformStorage"			Desc="Sleep Electroencephalogram Waveform Storage"			Uid="1.2.840.10008.5.1.4.1.1.9.7.4"
DirectoryRecord="WAVEFORM"		Name="BodyPositionWaveformStorage"						Desc="Body Position Waveform Storage"						Uid="1.2.840.10008.5.1.4.1.1.9.8.1"
...
DirectoryRecord="PRESENTATION"		Name="AdvancedBlendingSoftcopyPresentationStateStorage"	Desc="Advanced Blending Softcopy Presentation State Storage"	Uid="1.2.840.10008.5.1.4.1.1.11.8"
...
DirectoryRecord="PRESENTATION"		Name="VariableModalityLUTSoftcopyPresentationStateStorage"	Desc="Variable Modality LUT Softcopy Presentation State Storage"	Uid="1.2.840.10008.5.1.4.1.1.11.12"
...
DirectoryRecord="IMAGE"			Name="ConfocalMicroscopyImageStorage"						Desc="Confocal Microscopy Image Storage"							Uid="1.2.840.10008.5.1.4.1.1.77.1.8"
DirectoryRecord="IMAGE"			Name="ConfocalMicroscopyTiledPyramidalImageStorage"			Desc="Confocal Microscopy Tiled Pyramidal Image Storage"			Uid="1.2.840.10008.5.1.4.1.1.77.1.9"
...
DirectoryRecord="RADIOTHERAPY"		Name="RTPhysicianIntentStorage"					Desc="RT Physician Intent Storage"						Uid="1.2.840.10008.5.1.4.1.1.481.10"
DirectoryRecord="RADIOTHERAPY"		Name="RTSegmentAnnotationStorage"				Desc="RT Segment Annotation Storage"					Uid="1.2.840.10008.5.1.4.1.1.481.11"
DirectoryRecord="RADIOTHERAPY"		Name="RTRadiationSetStorage"					Desc="RT Radiation Set Storage"							Uid="1.2.840.10008.5.1.4.1.1.481.12"
DirectoryRecord="RADIOTHERAPY"		Name="CArmPhotonElectronRadiationStorage"		Desc="C-Arm Photon-Electron Radiation Storage"			Uid="1.2.840.10008.5.1.4.1.1.481.13"
DirectoryRecord="RADIOTHERAPY"		Name="TomotherapeuticRadiationStorage"			Desc="Tomotherapeutic Radiation Storage"				Uid="1.2.840.10008.5.1.4.1.1.481.14"
DirectoryRecord="RADIOTHERAPY"		Name="RoboticArmRadiationStorage"				Desc="Robotic-Arm Radiation Storage"					Uid="1.2.840.10008.5.1.4.1.1.481.15"
DirectoryRecord="RADIOTHERAPY"		Name="RTRadiationRecordSetStorage"				Desc="RT Radiation Record Set Storage"					Uid="1.2.840.10008.5.1.4.1.1.481.16"
DirectoryRecord="RADIOTHERAPY"		Name="RTRadiationSalvageRecordStorage"			Desc="RT Radiation Salvage Record Storage"				Uid="1.2.840.10008.5.1.4.1.1.481.17"
DirectoryRecord="RADIOTHERAPY"		Name="TomotherapeuticRadiationRecordStorage"	Desc="Tomotherapeutic Radiation Record Storage"			Uid="1.2.840.10008.5.1.4.1.1.481.18"
DirectoryRecord="RADIOTHERAPY"		Name="CArmPhotonElectronRadiationRecordStorage"	Desc="C-Arm Photon-Electron Radiation Record Storage"	Uid="1.2.840.10008.5.1.4.1.1.481.19"
DirectoryRecord="RADIOTHERAPY"		Name="RoboticRadiationRecordStorage"			Desc="Robotic Radiation Record Storage"					Uid="1.2.840.10008.5.1.4.1.1.481.20"
...
DirectoryRecord="IMAGE"			Name="LabelMapSegmentationStorage"		Desc="Label Map Segmentation Storage"	Uid="1.2.840.10008.5.1.4.1.1.66.7"
DirectoryRecord="IMAGE"			Name="HeightMapSegmentationStorage"		Desc="Height Map Segmentation Storage"	Uid="1.2.840.10008.5.1.4.1.1.66.8"
...
DirectoryRecord="ANNOTATION"	Name="MicroscopyBulkSimpleAnnotationsStorage"				Desc="Microscopy Bulk Simple Annotations Storage"	Uid="1.2.840.10008.5.1.4.1.1.91.1"
